-- Barangay-to-Barangay Distance Matrix for Bago City
-- Shipping fee formula: ₱25 base (covers 0–5 km) + ₱5 per km beyond 5 km
-- i.e. fee = ceil(25 + MAX(0, distance - 5) * 5)

USE bago_marketplace;

-- ── 1. Add missing barangay (Bacong-Montilla) if not present ──────────────────
...
CREATE TABLE IF NOT EXISTS barangay_distances (
    ...
    FOREIGN KEY (from_barangay_id) REFERENCES barangays(id),
    FOREIGN KEY (to_barangay_id)   REFERENCES barangays(id),
    INDEX idx_from (from_barangay_id),
    INDEX idx_to   (to_barangay_id)
);

-- ── 3. Seed distances (name-based, survives any id ordering) ─────────────────
-- Note: DB uses 'Ma-ao' (not 'Ma-ao Barrio') for the barangay name.

DROP PROCEDURE IF EXISTS seed_distances;

DELIMITER $$
CREATE PROCEDURE seed_distances()
BEGIN
    ...
    FROM (
          ...
          SELECT 'Abuanan','Ma-ao',                       3.99 UNION ALL
          ...
          SELECT 'Abuanan','Población',                  17.07 UNION ALL
          ...
          SELECT 'Alianza','Ma-ao',                       6.76 UNION ALL
          ...
          SELECT 'Alianza','Población',                  12.56 UNION ALL
          ...
          SELECT 'Atipuluan','Ma-ao',                      4.34 UNION ALL
          ...
          SELECT 'Atipuluan','Población',                 13.52 UNION ALL
          ...
          SELECT 'Bacong-Montilla','Ma-ao',                5.94 UNION ALL
          ...
          SELECT 'Bacong-Montilla','Población',           21.88 UNION ALL
          ...
          SELECT 'Bagroy','Ma-ao',                        12.76 UNION ALL
          ...
          SELECT 'Bagroy','Población',                     8.04 UNION ALL
          ...
          SELECT 'Balingasag','Ma-ao',                    16.58 UNION ALL
          ...
          SELECT 'Balingasag','Población',                 1.19 UNION ALL
          ...
          SELECT 'Binubuhan','Ma-ao',                      4.20 UNION ALL
          ...
          SELECT 'Binubuhan','Población',                 20.91 UNION ALL
          ...
          SELECT 'Busay','Ma-ao',                         12.64 UNION ALL
          ...
          SELECT 'Busay','Población',                      5.34 UNION ALL
          ...
          SELECT 'Calumangan','Ma-ao',                    14.63 UNION ALL
          ...
          SELECT 'Calumangan','Población',                 5.05 UNION ALL
          ...
          SELECT 'Caridad','Ma-ao',                        8.94 UNION ALL
          ...
          SELECT 'Caridad','Población',                   10.14 UNION ALL
          ...
          SELECT 'Dulao','Ma-ao',                          7.61 UNION ALL
          ...
          SELECT 'Dulao','Población',                     12.93 UNION ALL
          ...
          SELECT 'Ilijan','Ma-ao',                         8.27 UNION ALL
          ...
          SELECT 'Ilijan','Población',                    25.80 UNION ALL
          ...
          SELECT 'Jorge L. Araneta','Ma-ao',               4.93 UNION ALL
          ...
          SELECT 'Jorge L. Araneta','Población',          13.91 UNION ALL
          ...
          SELECT 'Lag-Asan','Ma-ao',                      16.84 UNION ALL
          ...
          SELECT 'Lag-Asan','Población',                   1.69 UNION ALL
          ...
          SELECT 'Ma-ao','Mailum',                         7.21 UNION ALL
          SELECT 'Ma-ao','Malingin',                       7.90 UNION ALL
          SELECT 'Ma-ao','Napoles',                       10.35 UNION ALL
          SELECT 'Ma-ao','Pacol',                         13.41 UNION ALL
          SELECT 'Ma-ao','Población',                     17.66 UNION ALL
          SELECT 'Ma-ao','Sagasa',                        10.84 UNION ALL
          SELECT 'Ma-ao','Sampinit',                      16.23 UNION ALL
          SELECT 'Ma-ao','Tabunan',                       10.87 UNION ALL
          SELECT 'Ma-ao','Taloc',                         12.47 UNION ALL

          SELECT 'Mailum','Malingin',                     14.83 UNION ALL
          SELECT 'Mailum','Napoles',                      17.49 UNION ALL
          SELECT 'Mailum','Pacol',                        20.26 UNION ALL
          SELECT 'Mailum','Población',                    24.83 UNION ALL
          ...
          SELECT 'Malingin','Población',                  10.22 UNION ALL
          ...
          SELECT 'Napoles','Población',                    7.35 UNION ALL
          ...
          SELECT 'Pacol','Población',                      5.86 UNION ALL
          ...
          SELECT 'Población','Sagasa',                     9.70 UNION ALL
          SELECT 'Población','Sampinit',                   1.78 UNION ALL
          SELECT 'Población','Tabunan',                   11.98 UNION ALL
          SELECT 'Población','Taloc',                      9.10 UNION ALL
    ...
    -- Mirror: insert reverse direction (matrix is symmetric)
    INSERT INTO barangay_distances (from_barangay_id, to_barangay_id, distance_km)
