            ...
            <div>
              ...
              {form.price > 0 && (
                <p className="text-xs mt-1 text-gray-500">
                  Listed price: <strong className="text-primary-800">₱{(parseFloat(form.price) * 1.02).toFixed(2)}</strong>
                  <span className="text-gray-400 ml-1">(+2% platform fee added automatically)</span>
                </p>
              )}
            </div>
            <div>
